...
<div class="mainbox">
    ...
    <div class="car-top">
        <div class="row">
            <div class="mainpic"> <img src="<%=car.getCarImage()%>" height="390"> <a href="#picture" class="showpic">查看图集</a> </div>
            <div class="carinfor">
                ...
                <div class="row">
                    ...
                    <div class="order_button"><a href="/collectController/addCollection?car_id=<%=car.getCarId()%>" class="shouchang" id="sendMESStx">收藏</a><!--<a href="#" class="yshouchang">已收藏</a>-->
                        <div id="fp">
            ...
            <div id="lumap">
                ...
                <script type="text/javascript">
                    ...
                    var markerArr = [{
                        ...
                        point:"117.272005|31.885464",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
                    ];
                    //创建marker
                    function addMarker(){
...
<div id="popBoxYzm" style="display:none">
    <div class="popForm">
        <div class="p-detail">
            <form action="/reserveController/addReservation?car_id=<%=car.getCarId()%>" enctype="multipart/form-data" method="post" name="yzmcheck" id="yzmcheck">
                <p class="p-tit">填写手机，阳光客服将在30分钟内联系您看车。</p>
                <ul class="login-items" style="width:100%">
                    <li>
                        <label>看车时间</label>
                        <input type="text" value="" maxlength="32"  name="time" id="shijian">
                    </li>
                    <li>
                        <label>看车地点</label>
                        <input type="text" value="" maxlength="32"  name="place" id="didian">
                    </li>
                    <li>
                    <label>手机号</label>
                    <input type="text" value="" maxlength="32"  name="phone" id="shoujihao">
                    </li>
                </ul>
                <div class="login-button">
                    <input type="submit"  value="立即提交" class="fM" style="line-height:20px" />
                </div>
            </form>
        </div>
