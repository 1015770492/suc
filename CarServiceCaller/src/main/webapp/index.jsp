...
<head>
    ...
    <script type="text/javascript" src="script/jquery-1.8.0.min.js" charset="UTF-8"></script>
    ...
    <script>
        $(document).ready(function() {
            $.getJSON("carinfoController/getIndexCars",function(data){
                var str="";
...
<div class="car_feature">
    <div class="menucar">
        <div class="more" id="11"><a href="cars.jsp">查看全部>></a></div>
        <ul>
            <li class="hover" id="tabs2_0" >热卖好车</li>
            <li id="tabs2_1" >最新上架</li>
            <li id="tabs2_2" >降价急售</li>
            <li id="tabs2_3" >准新车</li>
